...
DCC_AS="testdata/paired.DCC_analysis_summary.dat"

RUN_LIST="dat/paired.run_list-canonical.dat"
OUTFN="dat/paired.run_list-request.dat"
...
CMD="$PYTHON ../src/refine_run_list.py $@ -U <(cut -f 12,14 $DCC_AS) -o $OUTFN $RUN_LIST "
>&2 echo Running: $CMD
eval $CMD
