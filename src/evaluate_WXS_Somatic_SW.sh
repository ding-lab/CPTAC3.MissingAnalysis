# Usage: evaluate_WXS_Somatic_SW.sh DIS OUTD
...
DAS="/Users/mwyczalk/Projects/CPTAC3/CPTAC3.catalog/DCC_Analysis_Summary/WXS_Somatic_Variant_SW.DCC_analysis_summary.dat"
