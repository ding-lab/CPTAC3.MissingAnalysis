# Usage: evaluate_WXS_MSI.sh DIS OUTD

# Pipeline-specific definitions
# here, specify which columns in DCC analysis summary files have the UUIDs
DCC_UUID_COL="12,14"

# Processing WXS hg38 on MGI, excluding tissue_normal
DAS="/Users/mwyczalk/Projects/CPTAC3/CPTAC3.catalog/DCC_Analysis_Summary/WXS_MSI.DCC_analysis_summary.dat"
